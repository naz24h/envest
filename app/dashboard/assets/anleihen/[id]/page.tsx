                    ...
                    <div className='grid grid-cols-12 gap-8'>
                        ...
                        <div className='col-span-12 lg:col-span-8'>
                            <div className="flex flex-col gap-6">
                                {/* chart */}
                                <div className='p-4 md:p-6 box-shadow bg-white'>
                        ...
                        <div className='col-span-12 lg:col-span-4'>
                            <div className='sticky top-20 left-0 w-full'>
                                <div className="bg-primary text-white p-10">
                                    ...
                                    <div className='pt-11'>
                                        <div className="flex items-center space-x-2">
                                            <Button className='flex items-center space-x-2 py-2 px-3 w-full hover:bg-green-300 rounded-md'>
                                                <Icon name='arrow-right' className='w-3.5 h-3.5 stroke-black' />
                                                <span className='text-sm whitespace-nowrap'>Send Money</span>
                                            </Button>

                                            <Button className='flex items-center space-x-2 py-2 px-2 w-full bg-white/10 text-white hover:bg-white/20 rounded-md'>
