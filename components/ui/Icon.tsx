...
export default function Icon({ name, className = 'stroke-white' }: { name: string, className?: string }) {
    switch (name) {
        ...
        case 'like':
            return(
                <svg viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} >
                    <path d="M3.73999 9.43499L5.28999 10.635C5.48999 10.835 5.93999 10.935 6.23999 10.935H8.13999C8.73999 10.935 9.38999 10.485 9.53999 9.88499L10.74 6.23499C10.99 5.53499 10.54 4.93499 9.78999 4.93499H7.78999C7.48999 4.93499 7.23999 4.68499 7.28999 4.33499L7.53999 2.73499C7.63999 2.28499 7.33999 1.78499 6.88999 1.63499C6.48999 1.48499 5.98999 1.68499 5.78999 1.98499L3.73999 5.03499" stroke="#123857" stroke-width="1.5" stroke-miterlimit="10"/>
                    <path d="M1.19 9.43398V4.53398C1.19 3.83398 1.49 3.58398 2.19 3.58398H2.69C3.39 3.58398 3.69 3.83398 3.69 4.53398V9.43398C3.69 10.134 3.39 10.384 2.69 10.384H2.19C1.49 10.384 1.19 10.134 1.19 9.43398Z" stroke="#123857" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            )
    }
}